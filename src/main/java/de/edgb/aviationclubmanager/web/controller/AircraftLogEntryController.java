...
public class AircraftLogEntryController {
    ...
    public String clubaircraftlogForm(Model uiModel) {
	    ...
	    public String listClubaircraftToday(Model uiModel) {
			...
			List<Flight> fl = Flight.findFlightsByFlightDateEqualsAndClubaircraft(Util.getCurrentDate(), messageSource.getMessage("app.club", null, LocaleContextHolder.getLocale()));
		    ...
		    public String listClubaircraftYesterday(Model uiModel) {
				...
				List<Flight> fl = Flight.findFlightsByFlightDateEqualsAndClubaircraft(Util.getCurrentDate().minusDays(1), messageSource.getMessage("app.club", null, LocaleContextHolder.getLocale()));
		    ...
		    public String listClubaircraft(@RequestParam @org.springframework.format.annotation.DateTimeFormat(style = "M-") Date flightDate, Model uiModel) {
		        
				List<Flight> fl = Flight.findFlightsByFlightDateEqualsAndClubaircraft(Util.convertDateToLocalDate(flightDate), messageSource.getMessage("app.club", null, LocaleContextHolder.getLocale()));
