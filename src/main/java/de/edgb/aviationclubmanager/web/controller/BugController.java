...
public class BugController {
	...
	public String create(@ModelAttribute Bug bug, BindingResult bindingResult,
			Model uiModel, HttpServletRequest httpServletRequest) {

		// aktuellen Benutzer und Datum setzen
		bug.setBugDate(Util.getCurrentDateTime());
		bug.setPerson(((UserAccountDetails) SecurityContextHolder.getContext()
		...
		return "redirect:/bugs/"
				+ encodeUrlPathSegment(bug.getId().toString(),
						httpServletRequest);
	}
	...
	public String list(
		...
		if (page != null || size != null) {
			...
			final int firstResult = page == null ? 0 : (page.intValue() - 1)
					* sizeNo;
			uiModel.addAttribute("bugs",
					Bug.findBugEntries(firstResult, sizeNo));
	...
	public String update(@ModelAttribute Bug bug, BindingResult bindingResult,
			Model uiModel, HttpServletRequest httpServletRequest) {
