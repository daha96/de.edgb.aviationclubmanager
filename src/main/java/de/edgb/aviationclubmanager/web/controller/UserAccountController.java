...
public class UserAccountController {
    ...
    public String create(@ModelAttribute UserAccount userAccount, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
    ...
    public String update(@ModelAttribute UserAccount userAccount, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
		
		// Passwort beibehalten
        userAccount.setPassword(UserAccount.findUserAccount(userAccount.getId()).getPassword());
    ...
    public String delete(@PathVariable("id") Long id, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
        ...
        if (userAccount.getId().equals(((UserAccountDetails)SecurityContextHolder.getContext().getAuthentication().getPrincipal()).getUserAccount().getId()))
    ...
    public String updatePassword(@PathVariable("id") Long id, @ModelAttribute("changePassword") ChangePasswordModelLight changePassword, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
		...
		ua.setPassword(encoder.encodePassword(changePassword.getNewPassword(), null));
        ua.merge();
        return "redirect:/useraccounts/" + encodeUrlPathSegment(ua.getId().toString(), httpServletRequest);
    }
