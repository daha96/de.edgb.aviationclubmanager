...
public class WinchDriverPresenceController {
    ...
    public String create(@ModelAttribute WinchDriverPresence winchDriverPresence, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
        
		winchdriverPresenceValidator.validate(winchDriverPresence, bindingResult);
        ...
        return "redirect:/winchdriverpresences/" + encodeUrlPathSegment(winchDriverPresence.getId().toString(), httpServletRequest);
    }
    ...
    public String show(@PathVariable("id") Long id, Model uiModel) {
        ...
        uiModel.addAttribute("winchdriverpresence", WinchDriverPresence.findWinchDriverPresence(id));
    ...
    public String list(@RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
        if (page != null || size != null) {
            ...
            uiModel.addAttribute("winchdriverpresences", WinchDriverPresence.findWinchDriverPresenceEntries(firstResult, sizeNo));
            float nrOfPages = (float) WinchDriverPresence.countWinchDriverPresences() / sizeNo;
            uiModel.addAttribute("maxPages", (int) ((nrOfPages > (int) nrOfPages || nrOfPages == 0.0) ? nrOfPages + 1 : nrOfPages));
        } else {
            uiModel.addAttribute("winchdriverpresences", WinchDriverPresence.findAllWinchDriverPresences());
        }
        addDateTimeFormatPatterns(uiModel);
    ...
    public String update(@ModelAttribute WinchDriverPresence winchDriverPresence, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
    ...
    public String updateForm(@PathVariable("id") Long id, Model uiModel) {
        populateEditForm(uiModel, WinchDriverPresence.findWinchDriverPresence(id));
        return "winchdriverpresences/update";
    }
    ...
    public String delete(@PathVariable("id") Long id, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
        WinchDriverPresence winchDriverPresence = WinchDriverPresence.findWinchDriverPresence(id);
	...
	void addDateTimeFormatPatterns(Model uiModel) {
        uiModel.addAttribute("winchDriverPresence_presencedate_date_format", DateTimeFormat.patternForStyle("M-", LocaleContextHolder.getLocale()));
    }
	...
	void populateEditForm(Model uiModel, WinchDriverPresence winchDriverPresence) {
        ...
        addDateTimeFormatPatterns(uiModel);
        uiModel.addAttribute("clubmembers", ClubMember.findClubMembersBeingWinchDriver().getResultList());
    }
    ...
    public String findLatestWinchDriverPresences(Model uiModel) {
        uiModel.addAttribute("winchdriverpresences", WinchDriverPresence.findWinchDriverPresencesByPresenceDateGreaterThanEquals(Util.getCurrentDate()).getResultList());
