...
public class AircraftController {
    ...
    public String create(@Valid Aircraft aircraft, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
        ...
        uiModel.asMap().clear();
        aircraft.persist();
        return "redirect:/aircrafts/" + encodeUrlPathSegment(aircraft.getId().toString(), httpServletRequest);
    }
    ...
    public String list(@RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
        if (page != null || size != null) {
            ...
            uiModel.addAttribute("aircrafts", Aircraft.findAircraftEntries(firstResult, sizeNo));
    ...
    public String update(@Valid Aircraft aircraft, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
        if (bindingResult.hasErrors()) {
            populateEditForm(uiModel, aircraft);
	...
	void populateEditForm(Model uiModel, Aircraft aircraft) {
        ...
        uiModel.addAttribute("aircrafttypes", Arrays.asList(AircraftType.values()));
    }
}
