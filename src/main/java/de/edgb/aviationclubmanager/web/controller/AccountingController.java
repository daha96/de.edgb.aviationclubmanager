...
public class AccountingController {
	...
	public String create(@Valid Accounting accounting,
		...
		return "redirect:/accountings/"
				+ encodeUrlPathSegment(accounting.getId().toString(),
						httpServletRequest);
	}
	...
	public String list(
		...
		if (page != null || size != null) {
			...
			final int firstResult = page == null ? 0 : (page.intValue() - 1)
					* sizeNo;
			uiModel.addAttribute("accountings",
					Accounting.findAccountingEntries(firstResult, sizeNo));
	...
	public String update(@Valid Accounting accounting,
			BindingResult bindingResult, Model uiModel,
			HttpServletRequest httpServletRequest) {
		if (bindingResult.hasErrors()) {
			populateEditForm(uiModel, accounting);
