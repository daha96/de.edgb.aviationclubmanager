package de.edgb.aviationclubmanager.web.servlet.view.jasperreports;
...
public class CustomJasperReportsMultiFormatView extends
    ...
    public static final String DEFAULT_FILENAME_KEY = "filename";
    ...
    protected void renderReport(JasperPrint populatedReport,
        ...
        StringBuilder contentDisposition = new StringBuilder("attachement; filename=");
