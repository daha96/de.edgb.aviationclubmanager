...
public class UserAccount {
	...
	public static List<UserAccount> findAllUserAccounts() {
        return entityManager().createQuery("SELECT o FROM UserAccount o ORDER BY o.username", UserAccount.class).getResultList();
    }

	public static List<UserAccount> findUserAccountEntries(int firstResult, int maxResults) {
        return entityManager().createQuery("SELECT o FROM UserAccount o ORDER BY o.username", UserAccount.class).setFirstResult(firstResult).setMaxResults(maxResults).getResultList();
    }
}
